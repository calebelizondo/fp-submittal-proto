...
const Submittal = () => {
    ...
    return (
        <div>
            ...
            <div className={`w-full h-[100vh] grid grid ${isLargeScreen ? 'grid-cols-2' : ''}`}>
            <div className='p-4'>
                <div>
                    <div className="p-2">
            ...
            { isLargeScreen && (
                <iframe className='w-full h-full hidden md:block' src="/blank.pdf#toolbar=0&navpanes=0&scrollbar=0" />
            )}
        </div>
    </div>
  )
